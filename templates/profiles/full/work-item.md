...
fields:
  ...
  owner:
    required: true
    doc: Person or team accountable for the artifact (resolves to a User; see WP-008).
  status:
    required: true
...
relationships:
  assignee:
    target: Actor
    max: 1
    doc: The User or Team currently doing the work (optional; notified on assignment).
---
